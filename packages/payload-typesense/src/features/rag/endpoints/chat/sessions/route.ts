...
import { SessionConfig, getUserSessions } from '../../../handlers/session-handlers.js';

/**
 * Configuration for sessions list endpoint
 */
export type SessionsListEndpointConfig<TSlug extends CollectionSlug> = {
 ...
 */
export function createSessionsListGETHandler<TSlug extends CollectionSlug>(config: SessionsListEndpointConfig<TSlug>) {
